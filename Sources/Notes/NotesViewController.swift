...
//    private var items = [NotesViewModelLegacy.State.Item]()
//
//    private let viewModel: NotesViewModelLegacy
...
//
//    init(
//        viewModel: NotesViewModelLegacy,
...
//    }
//
//    private func handleState(state: NotesViewModelLegacy.State) {
//        switch state {
...
//    }
//
//    private func handleFilledState(items: [NotesViewModelLegacy.State.Item]) {
//        self.items = items
